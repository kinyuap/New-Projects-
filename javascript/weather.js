...
//get date and time 
var d = new Date();
var time = Math.floor(d.getTime() / 1000); //remove millisecond 
...
function accessLocation() {
  if (navigator.geolocation) {
    ...
    alert("Unable to access your location, please make sure you have allowed CodePen and your browser to access your location");
...
function position (pos) {
  ...
  const LON = pos.coords.longitude;
   ...
   let url = "https://weather-proxy.freecodecamp.rocks/api/current";
    ...
    fetch(url).then((res) => res.json()).then(weather);
...
function weather(data) {
  // Selects the <img> element with the ID 'icon'
...
/*Converts celcious to fahrenheit and vice-versa*/
